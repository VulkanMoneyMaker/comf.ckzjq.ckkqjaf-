package comz.slotonlinego.apsoii.dfsasdfsd;
...
/**
 * Created by fdslfnsdlkl on 31.01.2018.
 */

public class NetworkDelegat {

    private static final String BASE_URL = "http://188.166.93.168/api/v1/links/swap/";
